    ...
    <body>
       ...
       <div class="box">
        ...
        <div class="register-form">
            ...
            <!-- 输入框盒子 -->
            <div class="input-box">
                <input type="text" name="usernameR" id="usernameR" placeholder="用户名">
                <input type="password" name="passwordR" id="passwordR"  placeholder="密码">
        ...
        <div class="login-form">
            ...
            <!-- 输入框盒子 -->
                <form action="login.action" method="post"><div class="input-box">
                    <input type="text" name="username" id="username" placeholder="用户名">
                    <input type="password" name="password" id="password" placeholder="密码">
                    <input type="submit" value="登录" <%--class="btn-box"--%>></div>
                </form>
            <!-- 按钮盒子 -->
            <div class="btn-box">
                <%--<button onclick="loginR()">登录</button>--%>
                <!-- 绑定点击事件 -->
    ...
    <script>
        function loginR() {
            if(document.getElementById("username1").value===""||document.getElementById("password1").value===""){
                ...
                window.location.href = "login.action?username=" + username + "&password=" + password;
            }
        }
        function register() {
            ...
            //post方式请求，如果返回success则登滑回陆界面

            if(username===""||password===""||phone===""||email===""){
                alert("请输入完整信息")
            }else{
                window.location.href = "register.action?username=" + username + "&password=" + password + "&phone=" + phone + "&email=" + email;
            }
        }
